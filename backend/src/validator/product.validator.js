...
export const createProductValidator = [
    ...
    body("priceAmount").isNumeric().notEmpty().withMessage("Product price must be a number"),
    body("priceCurrency").optional().isIn(["INR", "USD", "EUR", "GBP", "JPY", "PKR"]).withMessage("Invalid currency - Must be one of INR, USD, EUR, GBP, JPY, PKR"),
];